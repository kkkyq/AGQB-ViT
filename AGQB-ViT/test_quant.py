...
def get_args_parser():
    parser = argparse.ArgumentParser(description="AGQB-ViT", add_help=False)
    ...
    parser.add_argument('--w_cw', default=True, help='weight channel-wise if assign')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('AGQB-ViT', parents=[get_args_parser()])
